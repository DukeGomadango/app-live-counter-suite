                ...
                sections: [
                    {
                        ...
                        items: [
                            ...
                            "項目はドラッグで動かさず、画面サイズと設定のカードサイズ（S〜XL）に合わせて間隔を含めて自動で整列します。幅が狭いときは余白を詰めます。項目が2個以上あるとき、スマホ幅では3列を目安に、より広い画面では2列を目安に並びます。1行に収まらないときは折り返したり横にはみ出したりするので、はみ出す部分はパンで見られます（追加時・ウィンドウのリサイズ時・カードサイズ変更時）",
