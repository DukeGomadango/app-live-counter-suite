                ...
                sections: [
                    ...
                    },
                    {
                        ...
                        items: [
                            ...
                            "選択時は左に編集パネル（サイドバー）が表示されます。サイドバーは「画像」と「覆い」のタブに分かれており、「画像」タブで画像の選択・追加・トリミング・線で切り分け、「覆い」タブで覆いの形・MECE・フィルターと選択中の覆いの編集ができます。編集パネルと画像の境目をドラッグすると幅を調節でき（ガチャ・ルーレットと同様）、設定は保存されます",
