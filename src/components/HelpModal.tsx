                ...
                sections: [
                    ...
                    },
                    {
                        ...
                        items: [
                            ...
                            "サイドバーの「リール・図柄」タブで図柄マスタ・表示段数・ペイライン・天井・ボーナスゲーム数・ARTを編集できます。「テンプレート」タブで標準テンプレート（確率）の適用とカスタムテンプレートの保存・読み込みができます。「統計」タブで全員またはプレイヤーを選んでスピン履歴と集計（総BET・総払出・実質機械割・ボーナス/リプレイ/天井回数）を確認できます",
