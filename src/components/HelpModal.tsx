                ...
                sections: [
                    ...
                    },
                    {
                        ...
                        items: [
                            ...
                            "サイドバーの「線で切り分け」タブで「線で切り分けを開始」を押すと線編集に入り、「ペン」と「手」を切り替えられます。ペンモードではドラッグで線を引き、手モードでは線をクリックで選択・ドラッグで移動・Deleteで削除できます。上から線を引きたいときはペン、既存の線を直したいときは手に切り替えてください",
                            "線は画像の外側から引き始めてもよく、判定に使われるのは画像内の部分だけです。端から引きやすくするため、ヒット領域は画像より少し広くしています。スマホでは余白を多めにしています",
                            "「やり直し（1本削除）」で最後に引いた線を削除、「クリア」で全ての線を削除できます。「図形編集に戻る」で線を残したまま図形編集ステップに戻れます",
                        ]
                    },
                    {
                        title: "MECEアシスト",
