                ...
                sections: [
                    {
                        ...
                        items: [
                            ...
                            "図形編集ステップでは、丸・三角・四角・カスタム・自由描画の覆いを手動で追加できます。各覆いに「何を」（ラベル）と「いくつ」（目標・数字）を表示・編集できます。ツールバーの「線で切り分け」で線切り分けステップに戻れます",
                    ...
                    },
                    {
                        ...
                        items: [
                            ...
                            "ツールバーの「ペン」と「手」でモードを切り替えられます。ペンモードではドラッグで線を引き、手モードでは線をクリックで選択・ドラッグで移動・Deleteで削除できます。上から線を引きたいときはペン、既存の線を直したいときは手に切り替えてください",
