                ...
                sections: [
                    ...
                    },
                    {
                        ...
                        items: [
                            ...
                            "ドラッグで移動・角と辺のハンドルで拡大縮小・上端のハンドルまたは編集パネルの円形ダイアルで回転・編集パネルで色（スウォッチを押すとR・G・Bスライダーがその場に表示され、動かすとリアルタイムで反映。お気に入りに登録した色はスウォッチで一覧され、クリックで適用・「現在の色を登録」で追加できます）・ラベル・透明度・回転（度）を変更できます",
