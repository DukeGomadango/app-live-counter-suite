                ...
                sections: [
                    {
                        ...
                        items: [
                            ...
                            "項目はドラッグで動かさず、画面サイズと設定のカードサイズ（S〜XL）に合わせて間隔を含めて自動で整列します。幅が狭いときは余白を詰めます。項目が2個以上あるときは2列を目安に並び、1行に収まらないときは折り返したり横にはみ出したりするので、はみ出す部分はパンで見られます（追加時・ウィンドウのリサイズ時・カードサイズ変更時）",
                            ...
                            "画面上部の合計ノードに加算合計・減算合計・総合計が表示されます。減算合計はマイナス表示で、総合計は加算合計＋減算合計です。各項目はその下にグリッド状に並び、矢印は各項目から合計へ向かいます",
                    ...
                    },
                    {
                        ...
                        items: [
                            ...
                            "ズーム（拡大縮小）はできません。左上の「全体表示」ボタンですべてのノードが収まるように戻せます",
