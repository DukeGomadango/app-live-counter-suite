                ...
                sections: [
                    {
                        ...
                        items: [
                            ...
                            "パネル明けモードで「全達成」ボタンを押すと、目標の有無にかかわらずすべての覆いをまとめて開けられます",
                        ]
                    },
                    {
                        title: "図形の編集",
                ...
                sections: [
                    {
                        ...
                        items: [
                            ...
                            "項目はドラッグで動かさず、画面サイズに合わせて自動で整列します（追加時とウィンドウのリサイズ時）",
                            ...
                            "画面上部の合計ノードに加算合計・減算合計・総合計が表示されます。減算合計はマイナス表示で、総合計は加算合計＋減算合計です。各項目はその下に横に並び、矢印は項目から合計へ向かいます",
                            "合計ノードの各ラベルはダブルクリックで名前を変えられます",
                            "左メニューの「目標」から総合計の目標値を設定できます（進捗バーは総合計と比較します）"
                        ]
                    },
                    {
                        title: "裏技",
                ...
                sections: [
                    {
                        ...
                        items: [
                            ...
                            "カード左上の「目標へ」ボタンから、その項目のカウントを目標値まで一気に進められます（「目標を達成しますか？」の確認後に反映されます）。目標達成後は「✓ 達成」と表示されます",
                            "左上のメニュー（≡）からテンプレート選択・項目の追加・目標値・色の変更ができます。メニュー内の「目標」タブには、各項目別の目標入力に加えて「全目標達成」ボタンと項目ごとの「✓達成」ボタンがあり、いずれも確認後に目標までカウントを進められます",
