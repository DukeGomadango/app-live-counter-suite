            ...
            return {
                ...
                sections: [
                    ...
                    },
                    {
                        title: "保存・共有",
                        items: [
                            "ヘッダー右側（ヘルプの左）の「画像を保存して X で共有」ボタンで共有できます。対応端末では共有シートから画像付きで共有でき、未対応時は画像保存後にXの投稿画面を開けます。キャプチャはトリミングした枠に合わせて出力されるため、余白なしで共有できます",
            ...
            return {
                ...
                sections: [
                    ...
                    },
                    {
                        title: "結果と共有",
                        items: [
                            "「画像で共有」ボタン（ヘルプの左）で進捗を1枚の画像にし、対応端末では共有シートで画像付き共有、未対応時はダウンロードとX投稿用画面を開けます",
                        ]
                    }
                ]
            };
