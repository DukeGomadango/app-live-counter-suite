  ...
  return (
    <div className="lp-root min-h-screen flex flex-col relative overflow-x-hidden select-none bg-transparent font-[family-name:var(--font-outfit)]">
      ...
      <main className="relative z-10 flex-1 flex flex-col items-center">
        ...
        <section className="w-full max-w-7xl mx-auto px-6 pt-8 md:pt-16 pb-16 md:pb-24 grid grid-cols-1 md:grid-cols-12 gap-8 items-center min-h-[85vh] relative">
          ...
          {isMobile && (
            <div className="absolute inset-0 w-full h-full z-0 opacity-55 pointer-events-none flex items-center justify-center">
              {hasWebGL === false ? (
                ...
                <ErrorBoundary fallback={<DangoOrb2D pulseTrigger={pulseTrigger} />}>
                  <DangoOrb3D 
          ...
          <div className="col-span-1 md:col-span-7 flex flex-col justify-center text-center md:text-left z-10">
            ...
            <div className="flex flex-wrap justify-center md:justify-start gap-4 mb-10">
              <button
                ...
                className="px-8 py-4 rounded-2xl bg-white text-black font-extrabold text-base sm:text-lg shadow-xl shadow-white/5 flex items-center gap-2 hover:bg-zinc-200 transition-all active:scale-98 cursor-pointer"
              >
          ...
          {!isMobile && (
            <div className="col-span-1 md:col-span-5 w-full h-[400px] md:h-[600px] z-10 flex items-center justify-center relative">
              ...
              {hasWebGL !== false && (
                <div className="absolute bottom-6 right-6 p-4 rounded-2xl border border-white/5 bg-zinc-950/40 backdrop-blur-md pointer-events-none flex flex-col gap-1 items-end">
        ...
        {/* ================= SECTION 1: BENETIFS (Unique value props) ================= */}
